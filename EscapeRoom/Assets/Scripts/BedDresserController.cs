...
public class BedDresserController : MonoBehaviour
{
    ...
    [SerializeField] private string openAnimationName = "bedDresserOpen";
    [SerializeField] private string closeAnimationName = "bedDresserClose";
