...
public class RedCouchController : MonoBehaviour
{
    private Animator dresserAnim;
    private bool dresserOpen = false;

    [Header("Animation Names")]
    [SerializeField] private string openAnimationName = "RedCouchPillowOpen";
    [SerializeField] private string closeAnimationName = "RedCouchPillowClose";
